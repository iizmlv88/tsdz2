...
function filterObj(obj: newObj[], property: string, value: string): newObj[] {
  console.log(obj);
...
function firstObj(objects: newObj[], property: string, value: string): newObj | undefined {
  console.log(obj);
...
function calc(objects: NumericObject[]): number {
  let sum = 0;
  let count = 0;
